...
bool tree_sitter_talon_list_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_talon_list_external_scanner_serialize(void *, char *);
void tree_sitter_talon_list_external_scanner_deserialize(void *, const char *, unsigned);
